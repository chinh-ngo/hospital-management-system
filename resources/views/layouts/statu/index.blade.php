...
@section('content')
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <a class="modal-with-form btn btn-default" href="#modalForm"><span class="fa fa-plus"></span> Add status</a>
            <!-- Modal Form -->
            <div id="modalForm" class="modal-block modal-block-primary mfp-hide">
                <section class="panel">

                    <form method="POST" action="{{url('/statu/add')}}">
                        @csrf
                        <header class="panel-heading">
                            <h2 class="panel-title">Add status</h2>
                        </header>
            ...
            <div id="modalForm1" class="modal-block modal-block-primary mfp-hide">
                <section class="panel">
                    ...
                    <form method="POST" action="{{url('/statu/update')}}">
                        @csrf
                        <header class="panel-heading">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
                ...
                @foreach($status as $statu)
                    <tr>
                        <td>{{$statu->name}}</td>
                        <td><a><i href="#modalForm1" onclick="update('{{$statu}}')" class="modal-with-form fa fa-pencil"></i></a>   <a class="delete-row" href="/statu/delete/{{$statu->id}}"><i  class="fa fa-trash-o"></i></a> </td>
                    </tr>
                @endforeach
                </tbody>
            </table>
...
@section('footer')
    ...
    <script>
        ...
        $('#menu_status').addClass('nav-active');
