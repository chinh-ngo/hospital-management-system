...
@section('content')
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <a class="modal-with-form btn btn-default" href="#modalForm"><span class="fa fa-plus"></span> Add statu</a>
            <!-- Modal Form -->
            <div id="modalForm" class="modal-block modal-block-primary mfp-hide">
                <section class="panel">
                    ...
                    <form method="POST" action="">
                        @csrf
                        <header class="panel-heading">
                            <h2 class="panel-title">Add statu</h2>
                        </header>
        ...
        <div class="panel-body">
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
                ...
                @foreach($status as $statu)
                    <tr>
                        <td>{{$statu->name}}</td>
                        <td><a><i onclick="update('{{$statu}}')" class="fa fa-pencil"></i></a>   <a class="delete-row" href="/statu/delete/{{$hmo->id}}"><i  class="fa fa-trash-o"></i></a> </td>
                    </tr>
                @endforeach
                </tbody>
            </table>
