...
@section('content')
    ...
    <section class="panel">
        ...
        <form class="form-horizontal mb-lg" method="POST" action="{{route('report.add.post')}}" enctype="multipart/form-data">
            @csrf
        <header class="panel-heading">
            <h2 class="panel-title">Add Report</h2>
        </header>
        <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="projectLocation" class="form-control" required/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="challenges" class="form-control" required />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="file" name="uploadDoc" class="form-control" required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="superDivision" class="form-control" required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="superLocation" class="form-control" required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="impactProject" class="form-control" required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea rows="5" name="zonalComment" class="form-control" required></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">Divisional Head Comment</label>
                    <div class="col-sm-9">
                        <textarea rows="5" name="divisionalComment" class="form-control" required></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">HOD Comment</label>
                    <div class="col-sm-9">
                        <textarea rows="5" name="hodComment" class="form-control" required></textarea>
                    </div>
                </div>
