...
@section('content')
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <a class="modal-with-form btn btn-default" href="#modalForm"><span class="fa fa-plus"></span> Add Department</a>
            <!-- Modal Form -->
            ...
            <div id="modalForm1" class="modal-block modal-block-primary mfp-hide">
                <section class="panel">
                    ...
                    <form method="POST" action="{{url('/department/update')}}">
                        @csrf
                        <header class="panel-heading">
            ...
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
                ...
                @foreach($departments as $department)
                    <tr>
                        ...
                        <td><a><i href="#modalForm1" onclick="update('{{$department}}')" class="modal-with-form fa fa-pencil"></i></a>   <a class="delete-row" href="/department/delete/{{$department->id}}"><i  class="fa fa-trash-o"></i></a> </td>
                    </tr>
                @endforeach
                </tbody>
            </table>
...
@section('footer')
    ...
    <script>
        ...
        $('#menu_departments').addClass('nav-active');
