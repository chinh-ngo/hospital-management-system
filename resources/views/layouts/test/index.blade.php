...
@section('content')
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <a class="modal-with-form btn btn-default" href="#modalForm"><span class="fa fa-plus"></span> Add Test</a>
            <!-- Modal Form -->
            <div id="modalForm" class="modal-block modal-block-primary mfp-hide">
                <section class="panel">

                    <form method="POST" action="{{url('/test/add')}}">
                        @csrf
                        <header class="panel-heading">
            ...
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
                ...
                @foreach($tests as $test)
                    <tr>
                        <td>{{$test->name}}</td>
                        <td>{{$test->amount}}</td>
                        <td><a><i href="#modalForm1" onclick="update('{{$test}}')" class="modal-with-form fa fa-pencil"></i></a>   <a class="delete-row" href="/test/delete/{{$test->id}}"><i  class="fa fa-trash-o"></i></a> </td>
                    </tr>
                @endforeach
                </tbody>
            </table>
...
@section('footer')
    ...
    <script>
        ...
        $('#menu_tests').addClass('nav-active');
